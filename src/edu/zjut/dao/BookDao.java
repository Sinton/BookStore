...
/*public class BookDao {
	...
	*//**
	...
	public void edit(Book book) throws SQLException {
		...
		Object[] params = { book.getName(), book.getAuthor(), book.getPrice(),
				book.getCurrPrice(), book.getDiscount(), book.getPublishing(),
				book.getPublishTime(), book.getEdition(), book.getPageNum(),
				book.getWordNum(), book.getPrintTime(), book.getBooksize(),
				book.getPaper(), book.getCategory().getCategoryId(),
				book.getBookId() };
	...
	*//**
	...
	public PageBean<Book> findByCombination(Book criteria, int pc) throws SQLException {
		List<Expression> exprList = new ArrayList<Expression>();
		exprList.add(new Expression("bname", "like", "%" + criteria.getName() + "%"));
	...
	*//**
	...
	public void add(Book book) throws SQLException {
		String sql = "insert into t_book(bid,bname,author,price,currPrice," +
				...
				" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		Object[] params = {book.getBookId(),book.getName(),book.getAuthor(),
